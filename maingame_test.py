...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:  # Left mouse button
            ...
            if not dealing and shuffle_complete and deck_area.collidepoint(mouse_pos):
            ...
            # Done drawing logic
            elif not dealing and button_area.collidepoint(mouse_pos):
                ...
                current_player = 2 if current_player == 1 else 1  # Switch to the next player
