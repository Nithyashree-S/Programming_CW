...
def start_screen():
    ...
    TWO_PLAYER_IMAGE_PATH = os.path.join(GAME_IMAGES, "2_Player_image.png")
    THREE_PLAYER_IMAGE_PATH = os.path.join(GAME_IMAGES, "3_Player_image.png")
    ...
    two_player_image = pygame.image.load(TWO_PLAYER_IMAGE_PATH).convert_alpha()
    three_player_image = pygame.image.load(THREE_PLAYER_IMAGE_PATH).convert_alpha()

    #create buttons
    start_button = Button(370, 300, start_button_image, 0.2)
    exit_button = Button(450, 450, exit_button_image, 0.5)
    two_player_button = Button(450, 550, two_player_image, 0.5)
    three_player_button = Button(450, 600, three_player_image, 0.5)
...
#            return "two_player"
        ...
        if three_player_button.draw(screen):
            pass
#            return "three_player"
...
def check_winning_state(player_id, player_hands): #check win fucntion
    ...
    if len(player_hands[player_id]) >5:
        print(f"Player {player_id} wins!") #Debug
...
def main_game_loop(): #ET~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    dealing_index, shuffle_complete, dealing, ai_turn_timer, message_timer, frame_count, deck_x, deck_y, win
    ...
    while running:
                        ...
                        if shuffle_complete and deck_area.collidepoint(mouse_pos):
                            ...
                            if len(drawn_cards) > 0:
                                ...
                                if is_hand_full(1):
                                    ...
                                    snatch_card()
                                    #ET~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                                    if check_winning_state(1, player_hands):
                                        return
                                    #ET~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        if current_player == 2 and not dealing and shuffle_complete:
            ...
            if ai_turn_timer == 0:
                ...
                ai_turn()
                #ET~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                if check_winning_state(2, player_hands):
                    return
                #ET~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                ai_turn_timer = 0
